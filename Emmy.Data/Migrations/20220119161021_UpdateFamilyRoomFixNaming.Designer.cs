...
namespace Emmy.Data.Migrations
{
    ...
    [Migration("20220119161021_UpdateFamilyRoomFixNaming")]
    partial class UpdateFamilyRoomFixNaming
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Discord.FamilyRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_family_rooms");

                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_family_rooms_user_id");

                    b.ToTable("family_rooms");
                });
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Discord.LoveRoom", b =>
                {
                    ...
                    b.HasIndex("User1Id")
                        .IsUnique()
                        .HasDatabaseName("ix_love_rooms_user1_id");

                    b.HasIndex("User2Id")
                        .IsUnique()
                        .HasDatabaseName("ix_love_rooms_user2_id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Discord.FamilyRoom", b =>
                {
                    b.HasOne("Emmy.Data.Entities.User.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_family_rooms_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Discord.LoveRoom", b =>
                {
                    b.HasOne("Emmy.Data.Entities.User.User", "User1")
                        .WithOne()
                        .HasForeignKey("Emmy.Data.Entities.Discord.LoveRoom", "User1Id")
                        .HasConstraintName("fk_love_rooms_users_user1_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Emmy.Data.Entities.User.User", "User2")
                        .WithOne()
                        .HasForeignKey("Emmy.Data.Entities.Discord.LoveRoom", "User2Id")
                        .HasConstraintName("fk_love_rooms_users_user2_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
