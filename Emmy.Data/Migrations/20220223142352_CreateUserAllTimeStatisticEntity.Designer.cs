...
namespace Emmy.Data.Migrations
{
    ...
    [Migration("20220223142352_CreateUserAllTimeStatisticEntity")]
    partial class CreateUserAllTimeStatisticEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Achievement", b =>
                {
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Crop", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Fish", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Fraction", b =>
                {
                    b.Property<byte>("Type")
                        .HasColumnType("smallint")
                        .HasColumnName("type");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Seed", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Transit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserContainer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserCooldown", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserDailyReward", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserFarm", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserFish", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserHangfireJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserReferrer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Crop", b =>
                {
                    b.HasOne("Emmy.Data.Entities.Seed", "Seed")
                        .WithOne("Crop")
                        .HasForeignKey("Emmy.Data.Entities.Crop", "SeedId")
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserAchievement", b =>
                {
                    b.HasOne("Emmy.Data.Entities.Achievement", "Achievement")
                        .WithMany()
                        .HasForeignKey("Type")
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserFish", b =>
                {
                    b.HasOne("Emmy.Data.Entities.Fish", "Fish")
                        .WithMany()
            ...
            modelBuilder.Entity("Emmy.Data.Entities.User.UserReferrer", b =>
                {
                    b.HasOne("Emmy.Data.Entities.User.User", "Referrer")
                        .WithMany()
