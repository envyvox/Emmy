...
namespace Emmy.Data.Migrations
{
    ...
    [Migration("20220119153333_CreateLoveRoomEntity")]
    partial class CreateLoveRoomEntity
    {
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Discord.FamilyRoom", b =>
                {
                    ...
                    b.HasIndex("OwnerId")
                        .IsUnique()
                        .HasDatabaseName("ix_family_rooms_owner_id");
            ...
            modelBuilder.Entity("Emmy.Data.Entities.Discord.FamilyRoom", b =>
                {
                    b.HasOne("Emmy.Data.Entities.User.User", "User")
                        ...
                        .HasConstraintName("fk_family_rooms_users_owner_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
