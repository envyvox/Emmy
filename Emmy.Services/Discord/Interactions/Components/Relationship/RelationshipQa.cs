        ...
        private async Task RelationshipStartTask()
        {
            var embed = new EmbedBuilder()
                ...
                .WithDescription(
                    ...
                    $"\n\n{_emotes.GetEmote("List")} Один из вас должен написать `/предложить-отношения`, а второй принять предложение нажав на кнопку в **личных сообщениях** с ботом.")
        ...
        private async Task LoveRoomCreateTask()
        {
            var embed = new EmbedBuilder()
                ...
                .WithDescription(
                    ...
                    $"\n\n{_emotes.GetEmote("List")} Приобрести {_emotes.GetEmote(KeyType.LoveRoom.EmoteName())} {_local.Localize(LocalizationCategory.Key, KeyType.LoveRoom.ToString())} в `/магазин-ключей`." +
        ...
        private async Task LoveRoomUpdateTask()
        {
            var embed = new EmbedBuilder()
                ...
                .WithDescription(
                    ...
                    $"\n\n{_emotes.GetEmote("List")} Приобрести новый {_emotes.GetEmote(KeyType.LoveRoom.EmoteName())} {_local.Localize(LocalizationCategory.Key, KeyType.LoveRoom.ToString())} в `/магазин-ключей`." +
