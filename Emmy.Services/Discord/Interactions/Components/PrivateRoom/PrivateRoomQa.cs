        ...
        private async Task Create()
        {
            var embed = new EmbedBuilder()
                ...
                .WithDescription(
                    ...
                    $"\n\n{_emotes.GetEmote("List")} Приобрести {_emotes.GetEmote(KeyType.PrivateRoom.EmoteName())} {_local.Localize(LocalizationCategory.Key, KeyType.PrivateRoom.ToString())} в {_emotes.GetEmote("DiscordSlashCommand")} `/магазин-ключей`." +
        ...
        private async Task Update()
        {
            ...
            var embed = new EmbedBuilder()
                ...
                .WithDescription(
                    ...
                    $"\n\n{_emotes.GetEmote("List")} Приобрести новый {_emotes.GetEmote(KeyType.PrivateRoom.EmoteName())} {_local.Localize(LocalizationCategory.Key, KeyType.PrivateRoom.ToString())} в {_emotes.GetEmote("DiscordSlashCommand")} `/магазин-ключей`." +
